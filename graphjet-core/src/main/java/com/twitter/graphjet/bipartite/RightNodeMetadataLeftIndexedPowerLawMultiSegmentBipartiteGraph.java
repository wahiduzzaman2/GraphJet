...
import com.twitter.graphjet.bipartite.segment.RightNodeMetadataLeftIndexedPowerLawSegmentProvider;
 ...
 */
public class RightNodeMetadataLeftIndexedPowerLawMultiSegmentBipartiteGraph
  extends RightNodeMetadataLeftIndexedMultiSegmentBipartiteGraph {
  /**
   ...
   */
  public RightNodeMetadataLeftIndexedPowerLawMultiSegmentBipartiteGraph(
    int maxNumSegments,
    ...
    super(
      ...
      new RightNodeMetadataLeftIndexedPowerLawSegmentProvider(
        ...
        edgeTypeMask,
        statsReceiver),
      new MultiSegmentReaderAccessibleInfoProvider<RightNodeMetadataLeftIndexedBipartiteGraphSegment>(
  ...
  ReusableNodeLongIterator initializeLeftNodeEdgesLongIterator() {
    return new RightNodeMetadataMultiSegmentIterator(
      this,
      new LeftSegmentEdgeAccessor<RightNodeMetadataLeftIndexedBipartiteGraphSegment>(
