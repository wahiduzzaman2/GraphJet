...
public class RightNodeMetadataLeftIndexedPowerLawSegmentProvider
  extends BipartiteGraphSegmentProvider<RightNodeMetadataLeftIndexedBipartiteGraphSegment> {
   ...
   */
  public RightNodeMetadataLeftIndexedPowerLawSegmentProvider(
  ...
  @Override
  public RightNodeMetadataLeftIndexedBipartiteGraphSegment generateNewSegment(
    int segmentId,
    int maxNumEdges
  ) {
    return new RightNodeMetadataLeftIndexedPowerLawBipartiteGraphSegment(
